...
#export LL_WRAPPER='valgrind --tool=memcheck --leak-check=full --error-limit=no --suppressions=/usr/lib/valgrind/glibc-2.5.supp --suppressions=secondlife-i686.supp'
